...
| Failure policy | malformed/in-progress JSONL entries are ignored; any other read/write failure is silent and degrades to cold — never to a false warm |

...
| Wrong account picked | `cat ~/.claude-profiles/.claudeb/.claudeb-state` (current), `~/.claude-profiles/.claudeb/disabled` (out of the worker pool), then inspect `worker-pick` output |

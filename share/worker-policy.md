...
- Gemini research is not a worker: the native `gemini-research` agent runs a read-only fan-out pass through role `research`, independent of the worker toggle and the workers/reviewers switches.
